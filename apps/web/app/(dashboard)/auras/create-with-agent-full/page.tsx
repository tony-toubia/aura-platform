          ...
          <>
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Create Your Aura with AI Assistant
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Let our AI guide you through creating the perfect personalized
                companion.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600">
                  Configure your Aura step by step with detailed controls. Any settings from the AI conversation are preserved here.
                </p>
              </div>
