// app/api/auth/google-fit/callback/route.ts
...
export async function GET(request: NextRequest) {
  ...
  const html = `
    ...
    <html>
      <head>
        <title>Google Fit OAuth Callback</title>
        <style>
          body {
      ...
      <body>
        <div class="container ${error ? 'error' : 'success'}">
          ${error ? `
            ...
            <p>Google Fit authorization was denied or failed.</p>
